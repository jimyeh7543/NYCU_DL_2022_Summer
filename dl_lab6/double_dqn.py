...
class DoubleDQN:
    ...
    def _update_behavior_network(self, gamma):
        ...
        with torch.no_grad():
            action_b = torch.max(self._behavior_net(next_state), 1)[1].view(-1, 1)
            q_next = self._target_net(next_state).gather(1, action_b.long())
...
def main():
    ...
    parser.add_argument('--seed', default=20220825, type=int)
